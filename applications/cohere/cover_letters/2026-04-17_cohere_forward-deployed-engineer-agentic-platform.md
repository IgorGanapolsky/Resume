Subject: Forward Deployed Engineer, Agentic Platform — Igor Ganapolsky

Hello Cohere hiring team,

I'd like to be considered for Forward Deployed Engineer, Agentic Platform. I spend most weeks translating between enterprise stakeholders and the engineers actually wiring the models up. Resume attached; a few notes below.

The JD mentions: "Each one of us is responsible for contributing to increasing the capabilities of our models and the value they drive for our customers." — that maps cleanly to the production-AI work I've been doing.
