Subject: Manager, Forward Deployed Engineering — Igor Ganapolsky

Hello Anthropic hiring team,

I'd like to be considered for Manager, Forward Deployed Engineering. I spend most weeks translating between enterprise stakeholders and the engineers actually wiring the models up. Resume attached; a few notes below.

The JD mentions: "Our Forward Deployed Engineers embed directly with strategic customers to ship production AI applications that solve real business problems." — that maps cleanly to the production-AI work I've been doing.
