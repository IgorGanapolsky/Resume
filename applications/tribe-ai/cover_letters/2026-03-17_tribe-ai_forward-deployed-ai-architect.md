Subject: Interest in Forward Deployed AI Architect

Hello Tribe AI team,

I am interested in the Forward Deployed AI Architect opportunity. My philosophy is that integration is a social problem, not just a technical one; i build 'api-first' relationships, not just endpoints. I build production AI/software systems where reliability is a non-negotiable.
