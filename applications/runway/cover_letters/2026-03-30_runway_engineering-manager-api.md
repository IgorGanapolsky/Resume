Subject: Interest in Engineering Manager, API

Hello Runway team,

I am interested in the Engineering Manager, API opportunity. My philosophy is that production ai is about reliability and cost-predictability, not just prompt engineering. I build production AI/software systems where reliability is a non-negotiable.
