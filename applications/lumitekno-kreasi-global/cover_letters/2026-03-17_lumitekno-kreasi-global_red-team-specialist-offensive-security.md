Subject: Interest in Red Team Specialist (Offensive Security)

Hello Lumitekno Kreasi Global team,

I am interested in the Red Team Specialist (Offensive Security) opportunity. My philosophy is that production ai is about reliability and cost-predictability, not just prompt engineering. I build production AI/software systems where reliability is a non-negotiable.
