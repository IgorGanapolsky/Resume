Subject: Interest in Senior Software Engineer Python Django PostgreSQL and Vue.js

Hello GHX team,

I am interested in the Senior Software Engineer Python Django PostgreSQL and Vue.js opportunity. My philosophy is that integration is a social problem, not just a technical one; i build 'api-first' relationships, not just endpoints. I build production AI/software systems where reliability is a non-negotiable.
