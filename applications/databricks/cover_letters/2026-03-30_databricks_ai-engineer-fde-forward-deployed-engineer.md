Subject: Interest in AI Engineer - FDE (Forward Deployed Engineer)

Hello Databricks team,

I am interested in the AI Engineer - FDE (Forward Deployed Engineer) opportunity. My philosophy is that integration is a social problem, not just a technical one; i build 'api-first' relationships, not just endpoints. I build production AI/software systems where reliability is a non-negotiable.
