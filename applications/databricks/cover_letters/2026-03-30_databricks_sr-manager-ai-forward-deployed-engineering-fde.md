Subject: Interest in Sr. Manager, AI Forward Deployed Engineering (FDE)

Hello Databricks team,

I am interested in the Sr. Manager, AI Forward Deployed Engineering (FDE) opportunity. My philosophy is that integration is a social problem, not just a technical one; i build 'api-first' relationships, not just endpoints. I build production AI/software systems where reliability is a non-negotiable.
