Subject: Sr. Forward Deployed Engineer — Igor Ganapolsky

Hello Databricks hiring team,

Saw the Sr. Forward Deployed Engineer opening and wanted to put my hat in. The part of the role I've lived the most is the integration arc — from scoping through first production outage.

The JD mentions: "Req number: CSQ427R29 About the Team The Forward Deployed Engineering (FDE) team is a highly specialized, customer-facing software engineering team at Databricks." — that maps cleanly to the production-AI work I've been doing.
