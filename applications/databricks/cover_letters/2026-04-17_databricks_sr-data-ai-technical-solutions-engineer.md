Subject: Sr Data & AI Technical Solutions Engineer — Igor Ganapolsky

Hello Databricks,

Writing re: Sr Data & AI Technical Solutions Engineer. Most of my recent work is the messy middle between customer teams and production AI — the part of the JD that's usually understated.

The JD mentions: "You will develop product expertise in a couple of areas by advising a broad set of customers and use cases across those technologies." — that maps cleanly to the production-AI work I've been doing.
