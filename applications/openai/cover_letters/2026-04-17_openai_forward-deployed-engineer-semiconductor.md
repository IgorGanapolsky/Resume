Subject: Forward Deployed Engineer - Semiconductor — Igor Ganapolsky

Hi OpenAI team,

Saw the Forward Deployed Engineer - Semiconductor opening and wanted to put my hat in. The part of the role I've lived the most is the integration arc — from scoping through first production outage.

The JD mentions: "About the role We are hiring a Forward Deployed Engineer (FDE) to lead end-to-end deployments of OpenAI’s models inside semiconductor and chip design organizations." — that maps cleanly to the production-AI work I've been doing.
