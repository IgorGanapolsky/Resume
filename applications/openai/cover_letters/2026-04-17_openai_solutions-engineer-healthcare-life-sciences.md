Subject: Solutions Engineer, Healthcare & Life Sciences — Igor Ganapolsky

Hello OpenAI hiring team,

Saw the Solutions Engineer, Healthcare & Life Sciences opening and wanted to put my hat in. The part of the role I've lived the most is the integration arc — from scoping through first production outage.

The JD mentions: "OpenAI's customers represent a range of diverse backgrounds and maturity, from early-stage startups to established global enterprises." — that maps cleanly to the production-AI work I've been doing.
