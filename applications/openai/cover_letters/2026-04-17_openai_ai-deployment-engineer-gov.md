Subject: AI Deployment Engineer, Gov — Igor Ganapolsky

Hi OpenAI team,

The AI Deployment Engineer, Gov posting caught my eye. For the last four years I've done a forward-deployed version of this work at Subway — sitting between product, data, and whichever vendor had the quickest path to a working demo.

The JD mentions: "About the team The AI Deployment Engineering team is responsible for ensuring the safe and effective deployment of Generative AI applications." — that maps cleanly to the production-AI work I've been doing.
