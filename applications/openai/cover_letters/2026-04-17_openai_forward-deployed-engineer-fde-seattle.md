Subject: Forward Deployed Engineer (FDE) - Seattle — Igor Ganapolsky

Hello OpenAI hiring team,

Saw the Forward Deployed Engineer (FDE) - Seattle opening and wanted to put my hat in. The part of the role I've lived the most is the integration arc — from scoping through first production outage.

The JD mentions: "About the team OpenAI’s Forward Deployed Engineering team partners with customers to turn research breakthroughs into production systems." — that maps cleanly to the production-AI work I've been doing.
