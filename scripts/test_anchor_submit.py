...
def run_targeted_submit():
    ...
    resume_path = os.path.abspath("applications/anthropic/tailored_resumes/Igor_Ganapolsky_Open_Source_Maintainer_AI.pdf")
    
    print(f"Starting Anchor Browser session for: {url}")
    
    with sync_playwright() as pw:
        browser = pw.chromium.connect_over_cdp(f"wss://connect.anchorbrowser.io?apiKey={anchor_key}")
        ...
        page.fill("textarea[id*='question_']", why_text) # Using partial ID for Greenhouse custom fields
