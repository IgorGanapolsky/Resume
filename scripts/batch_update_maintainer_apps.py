...
for row in rows:
    ...
    is_target_role = any(kw in role.lower() for kw in ["engineer", "infrastructure", "platform", "inference", "architect", "solutions"])
...
print("Batch updated Anthropic and Anyscale roles to ReadyToSubmit with Maintainer resume.")
