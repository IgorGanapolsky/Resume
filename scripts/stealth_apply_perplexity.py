...
async def apply():
    async with async_playwright() as p:
        ...
        await page.goto("https://jobs.ashbyhq.com/perplexity/bc1a6878-8de9-48c2-a791-95b2f8f27261/application", wait_until="networkidle")
        
        await human_mouse_move(page)
        
        print("Filling personal info...")
        await human_type(page, 'div[role="textbox"]:has-text("Name"), textbox[name*="name"], [placeholder*="Type here"]', "Igor Ganapolsky")
        await asyncio.sleep(random.uniform(1, 2))
        await human_type(page, 'div[role="textbox"]:has-text("Email"), textbox[name*="email"], [placeholder*="hello@example.com"]', "iganapolsky@gmail.com")
        await asyncio.sleep(random.uniform(1, 2))
        await human_type(page, 'div[role="textbox"]:has-text("Phone"), [placeholder*="1-415-555-1234"]', "2016391534")
        
        # Location
        await human_type(page, "input[placeholder*='Start typing']", "Coral Springs, FL")
        ...
        await page.screenshot(path="applications/perplexity/submissions/stealth_pre_submit.png")
        ...
        await page.screenshot(path="applications/perplexity/submissions/stealth_post_submit.png")
        await browser.close()
