...
for row in rows:
    if "Anthropic" in row["Company"] and "Autonomous Agent Infrastructure" in row["Role"]:
        row["Status"] = "Draft"
        row["Submitted Resume Path"] = "resumes/Igor_Ganapolsky_Open_Source_Maintainer_AI.html"
...
anyscale_row["Career Page URL"] = "https://jobs.ashbyhq.com/anyscale/23930b20-6d9b-466d-9654-9457f5979f4a" # Found earlier
anyscale_row["Submitted Resume Path"] = "resumes/Igor_Ganapolsky_Open_Source_Maintainer_AI.html"
